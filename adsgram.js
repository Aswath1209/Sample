...
class Adsgram {
    ...
    async getAd(tgUserId, language = 'en') {
        ...
        try {
            ...
            console.error("Failed to fetch ad from Adsgram, falling back to Mock Mode:", error.message);
            return this.getMockAd();
        }
    }
    ...
    getMockAd() {
        return {
            image_url: "https://picsum.photos/seed/adsgram/800/450", // Reliable placeholder image
